...
import useUserExist from "../../Hooks/useUserExist/useUserExist";
        ...
        <div className="navbar bg-base-100 border-2 rounded-xl border-[rgb(5,172,108)]">
            ...
            <div className="navbar-center hidden lg:flex">
             ...
             <div className="navbar-end">
                ...
                {
                //    className="text-xl ">LogOut</p>
                user && <button onClick={haldleLogout}  type="button" className="px-8 py-3 font-semibold border rounded dark:border-[rgb(5,172,108)] text-[rgb(5,172,108)]">Log Out</button>
                }
            </div>
